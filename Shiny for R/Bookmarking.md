Bookmarking allows for users to return to the same place where they left the application so if a person has selected parameters than they can save their work 
